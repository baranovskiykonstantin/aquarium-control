...
c:\Qt\6...\msvc...\bin\windeployqt.exe --qmldir z:\projects\aquarium-control\qml aquarium-control.exe
...
c:\QtIFW...\bin\binarycreator.exe --config config\config.xml --packages packages aquarium-control-2.2-windows_x86.exe
